  ...
  tabPanel("Help",
           fluidPage(width = 12,
                     fluidRow(column(
                       ...
                       h4("Mini-app layout"),
                       p("This help tab will gives you an overview of the mini-app itself, the other tab called 'DICOM Viewer' is the app itself."),
                       ...
                       h4("Using the App"),
                       p("You can select the patient file to display from the dropdown menu on the left. Then you can change the Orientation of the 
