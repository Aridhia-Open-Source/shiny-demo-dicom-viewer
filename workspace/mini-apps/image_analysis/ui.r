  ...
  fluidRow(
    ...
    column(width = 7,
           ...
           tabsetPanel(type = "tabs", 
                       tabPanel("Axial", div(class = "axialScroll", plotOutput("Axial", height = "450px", brush = "plot_brush"))), 
                       tabPanel("Sagittal", div(class = "sagittalScroll", plotOutput("Sagittal", height = "450px", brush = "plot_brush"))), 
                       tabPanel("Coronal", div(class = "coronalScroll", plotOutput("Coronal", height = "450px", brush = "plot_brush")))
           ),
           tableOutput("table"),
